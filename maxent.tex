...
Similarly the second variation of $f$ can be defined as follows

\begin{empheq}[box=\tcbhighmath]{equation}
  \begin{split}
      & \delxFfEta = \frac{d^2}{d\epsilon^2} F\left(\fe\right) \Bigr\rvert_{\epsilon=0} \\
      & = \frac{d}{d\epsilon} \delFfEta  \Bigr\rvert_{\epsilon=0} \\
  \end{split}
\end{empheq}
