...
Fortunately it turns out for our case, it is clear that sigin of the  second variation is same as that of $T$ 
    because $p(x)$ and $\eta^2$ are always positive. This explains our observed trend where our stationary points 
    tunred out to be minima when T is positive, and maxima when T is positive.
\end{tcolorbox}
